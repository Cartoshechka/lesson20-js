...
// Функция для создания разделителей секций
const section = (title) => console.log(`\n🔹 ${title} ${'─'.repeat(40 - title.length)}\n`);

section('Завдання #1: Створення об\'єкта userObj');
...
section('Завдання #2: Метод fullName()');
...
section('Завдання #3: Функція defUpperStr()');
...
section('Завдання #4: Функція evenFn()');
...
section('Завдання #5: Функція weekFn()');
...
section('Завдання #6: Функція ageClassification()');
...
section('Тестування ageClassification');
...
section('Завдання #7: Функція oddFn()');
...
section('Завдання #8: Функція mainFunc()');
...
// Основная функция mainFunc (из предыдущего задания)
...
console.log('cbRandom (2,5): ' + mainFunc(2, 5, cbRandom)) // цілі числа в діапазоні 2..5
console.log('cbPow (2,5): ' + mainFunc(2, 5, cbPow)) // 32
console.log('cbAdd(2,5): ' + mainFunc(2, 5, cbAdd)) // 7
console.log('mainFunc(2, 5, cbRandom) →', mainFunc(2, 5, cbRandom))
console.log('mainFunc(10, 30, cbRandom) →', mainFunc(10, 30, cbRandom))
console.log('mainFunc(2, 5, cbPow) →', mainFunc(2, 5, cbPow))
console.log('mainFunc(2, 5, cbAdd) →', mainFunc(2, 5, cbAdd))
console.log('mainFunc(2, 5, "not a func") →', mainFunc(2, 5, 'not a func'))
console.log(`not a func(2,5): ` + mainFunc(2, 5, 'not a func')) // false
